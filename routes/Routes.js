...
const { register, login, googleLogin, updateUser, getUser, getProfile, acceptApplication, cancelApplication ,updateOrder,saveReview } = require('../controllers/AuthController.js');
